...
const Dashboard = safeLazy(() => import('./components/Views/Dashboard').then(m => ({ default: m.Dashboard })));
const POS = safeLazy(() => import('./components/Views/POS').then(m => ({ default: m.POS })));
const Inventory = safeLazy(() => import('./components/Views/Inventory').then(m => ({ default: m.Inventory })));
const Customers = safeLazy(() => import('./components/Views/Customers').then(m => ({ default: m.Customers })));
const Reports = safeLazy(() => import('./components/Views/Reports/index').then(m => ({ default: m.Reports })));
const Settings = safeLazy(() => import('./components/Views/Settings').then(m => ({ default: m.Settings })));

import { Purchasing } from './components/Views/Purchasing';
const SuperAdminCPanel = safeLazy(() => import('./components/SuperAdminCPanel').then(m => ({ default: m.SuperAdminCPanel })));
const AuthGateway = safeLazy(() => import('./components/Views/AuthGateway').then(m => ({ default: m.AuthGateway })));
const UsersRoles = safeLazy(() => import('./components/Views/UsersRoles').then(m => ({ default: m.UsersRoles })));
const Expenses = safeLazy(() => import('./components/Views/Expenses').then(m => ({ default: m.Expenses })));
const BusinessConsulting = safeLazy(() => import('./components/Views/BusinessConsulting').then(m => ({ default: m.BusinessConsulting })));
const TechnicalCompany = safeLazy(() => import('./components/Views/TechnicalCompany').then(m => ({ default: m.TechnicalCompany })));
const AIInsightsView = safeLazy(() => import('./components/Views/AIInsightsView').then(m => ({ default: m.AIInsightsView })));
const CashDrawer = safeLazy(() => import('./components/Views/CashDrawer/CashDrawer').then(m => ({ default: m.CashDrawer })));
const Receipts = safeLazy(() => import('./components/Views/Receipts').then(m => ({ default: m.Receipts })));
const TrashCan = safeLazy(() => import('./components/Views/TrashCan').then(m => ({ default: m.TrashCan })));
const LawFirmModule = safeLazy(() => import('./components/Views/LawFirm').then(m => ({ default: m.LawFirmModule })));
const PharmacyModule = safeLazy(() => import('./components/Views/Pharmacy').then(m => ({ default: m.PharmacyModule })));
const PoultryLivestockModule = safeLazy(() => import('./components/Views/PoultryLivestock').then(m => ({ default: m.PoultryLivestockModule })));
